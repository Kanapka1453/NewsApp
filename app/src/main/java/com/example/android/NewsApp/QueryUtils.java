...
public class QueryUtils {
    ...
    static String createStringUrl() {
        ...
        builder.scheme("https")
                ...
                .appendQueryParameter("api-key", "a590d186-a87c-411f-935d-bbd6e7371a7b");
    ...
    static List<News> parseJson(String response) {
        ...
        try {
            ...
            for (int i = 0; i < resultsArray.length(); i++) {
                ...
                String tag = oneResult.getString("sectionName");
                ...
                listOfNews.add(new News(title, author, date, tag, url));
            }
